        ...
        <form action={formAction} className="startup-form">
            ...
            <div className="flex-center">
                ...
                <input
                    ...
                    name="category"
                    className="startup-form_input"
                    placeholder="Startup category (Tech, Health, Lifestyle...)"
                    required
                />
                {errors.category && (
            ...
            <div data-color-mode="light" className="flex-center">
                <label htmlFor="link" className="startup-form_label">
                    Pitch
                </label>
            ...
            <Button
                type="submit"
                className="startup-form_btn text-white rounded-full hover:cursor-pointer"
                disabled={isPending}
            >
